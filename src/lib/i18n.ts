...
const ar = {
  ...
  nav: {
    ...
    requests: "الطلبات",
    buysellRequests: "طلبات البيع والشراء",
    ...
    residentialSeekers: "طالبو العروض السكنية",
    users: "المستخدمون",
    myProfile: "حسابي",
  ...
  residentialSeekers: {
    pageTitle: "طالبو العروض السكنية (إيجار)",
    pageSubtitle: "بيانات العملاء الباحثين عن وحدة سكنية للإيجار",
    serialNumber: "الرقم التسلسلي",
    requestDate: "تاريخ الطلب",
    status: "الحالة",
    receiver: "المستلم",
