...
const en = {
  ...
  revenue: {
    title: "Revenue",
    add: "Add Revenue Entry",
    edit: "Edit Revenue Entry",
    date: "Date",
    employee: "Employee",
    offerCode: "Offer Code",
    category: "Category",
    owner: "Owner",
    tenantBuyer: "Tenant / Buyer",
    tenantPhone: "Tenant Phone",
    ownerBroker: "Owner Broker",
    tenantBroker: "Tenant Broker",
    amount: "Amount",
    officeNet: "Office Net",
    paymentMethod: "Payment Method",
    totalAmount: "Total Amount",
    totalOfficeNet: "Total Office Net",
    recordCount: "Records",
    categoryRent: "Rent",
    categorySale: "Sale",
  ...
  common: {
    ...
    all: "All",
    filters: "Filters",
    filterActive: "{{count}} active filter(s)",
    reset: "Reset",
    assign: "Assign",
    approve: "Approve",
    approveLead: "Approve & create listing",
    leadApproved: "Lead approved. Listing created.",
    ...
    selectableHelp: "Selectable amenities can be picked on properties and listings.",
    ...
    secondMobileNumber: "Second mobile number",
    ...
    match: "Match",
    autoMatched: "Top matches for this request",
    ...
    failedSetPrimaryImage: "Failed to set primary image",
    ...
    sortNewest: "Newest",
    sortOldest: "Oldest",
    sortContactDateNewest: "Contact date (newest)",
    sortContactDateOldest: "Contact date (oldest)",
  ...
  footer: {
    ...
    contact: "Contact us",
    explore: "Explore",
    addressLine1: "Saudi Arabia, Madinah",
  ...
  commercialListings: {
    ...
    keyHolder: "Key Location",
    keyWithOffice: "With the office",
    keyWithOwner: "With the owner",
    keyWithGuard: "With the guard",
    ...
    chooseCategoryFirst: "Choose a property category first",
    openInGoogleMaps: "Open in Google Maps",
  ...
  residentialSeekers: {
    ...
    requestCategory: "Property Category",
    statusActive: "Active",
    statusEnded: "Ended",
    statusDone: "Done",
    ...
    sortNewest: "Newest",
    sortOldest: "Oldest",
    sortRequestDateNewest: "Request date (newest)",
    sortRequestDateOldest: "Request date (oldest)",
  ...
  advertisements: {
    ...
    statusAwaitingInstallation: "Awaiting installation",
    statusExpired: "Expired",
    propertyTypeRent: "Rent",
    propertyTypeSale: "Sale",
    adTypeBoard: "Board",
    adTypeSticker: "Sticker",
    adTypeBoardBar: "Board (bar)",
    installationTypeWall: "Wall",
    installationTypeGround: "Ground",
    installationTypeFence: "Fence installation",
    installationTypeSticker: "Sticker",
  },
  leadStatus: {
    New: "New",
    Contacted: "Contacted",
  ...
  dashboard: {
    ...
    occupancyHelp:
      "Active rental contracts divided by approved properties. Your property will appear once approved.",
  ...
  notifications: {
    ...
    newSeekerResidential: "New residential request",
    newSeekerCommercial: "New commercial request",
    newLead: "New lead",
  ...
  clients: {
    pageTitle: "Clients",
    pageSubtitle: "Search a client to view all of their requests and listings",
    searchPlaceholder: "Search by name or mobile number…",
    searchSerial: "Search by serial number",
    sortLabel: "Sort",
    sortRecent: "Most recent activity",
    sortName: "Name",
    count: "{{count}} clients",
    ...
    kindSeekers: "Residential Requests",
    kindListings: "Listings",
    kindLeads: "Leads",
    sectionTitle: "{{kind}} ({{count}})",
...
const ar = {
  ...
  revenue: {
    ...
    category: "نوع البند",
    owner: "المالك",
    tenantBuyer: "المستأجر / المشتري",
    tenantPhone: "رقم المستأجر",
    ownerBroker: "وسيط مالك",
    tenantBroker: "وسيط مؤجر",
    amount: "القيمة",
    officeNet: "الصافي للمكتب",
    paymentMethod: "طريقة السداد",
    totalAmount: "إجمالي القيمة",
    totalOfficeNet: "إجمالي الصافي",
    recordCount: "عدد السجلات",
    categoryRent: "ايجار",
    categorySale: "بيع",
    categoryCommission: "عمولة",
    categoryOther: "اخرى",
  },
  common: {
    add: "إضافة",
    ...
    assign: "تعيين",
    approve: "اعتماد",
    approveLead: "اعتماد وإنشاء عرض",
    leadApproved: "تم اعتماد العميل وإنشاء العرض.",
    ...
    selectableHelp: "المرافق القابلة للتحديد يمكن اختيارها عند إضافة عقار أو إعلان.",
    ...
    secondMobileNumber: "رقم الجوال الثاني",
    nationality: "الجنسية",
    profession: "المهنة",
    ...
    invalidFields: "بعض الحقول غير صحيحة",
    ...
    usePartnersPageForPartnerAccounts: "استخدم صفحة الشركاء لإنشاء حسابات الشركاء.",
    createPartnerAccountDescription: "إنشاء حساب بوابة لهذا الشريك.",
    createOwnerAccountDescription: "إنشاء حساب بوابة لهذا المالك.",
    account: "الحساب",
    stats: "الإحصائيات",
    ...
    sortNewest: "الأحدث",
    sortOldest: "الأقدم",
    sortContactDateNewest: "تاريخ التواصل (الأحدث)",
    sortContactDateOldest: "تاريخ التواصل (الأقدم)",
    ...
    pendingOrPaid: "معلق أو مدفوع",
    commissionNotes: "ملاحظات العمولة",
    noImage: "لا توجد صورة",
    loadingPartners: "جارٍ تحميل الشركاء...",
    ...
    viewImages: "عرض {{count}} صور",
    employeeId: "الرقم الوظيفي",
    jobTitle: "المسمى الوظيفي",
    employeeName: "اسم الموظف",
    dateOfBirth: "تاريخ الميلاد",
    personalMobile: "الجوال الخاص",
    workMobile: "جوال العمل",
    employmentStartDate: "تاريخ المباشرة",
    employmentEndDate: "تاريخ الإيقاف",
    bank: "البنك",
    iban: "رقم الايبان",
  },
  auth: {
  ...
  landing: {
    heroTitle: "رؤية حديثة في ادارة و تسويق العقارات",
    heroSubtitle:
    ...
    feature2Body:
      "نرافقك في كل خطوة، من البحث عن العقار وحتى إتمام الصفقة، مع متابعة مستمرة وإجابة سريعة على جميع استفساراتك.",
    feature3Title: "خيارات عقارية موثوقة",
    feature3Body:
      "نوفر مجموعة متنوعة من العقارات المختارة بعناية، مع معلومات دقيقة وصور واضحة لمساعدتك على اتخاذ قرار بثقة.",
  },
  publicProperties: {
  ...
  footer: {
    ...
    contact: "تواصل معنا",
    explore: "استكشف",
    addressLine1: "المملكة العربية السعودية, المدينة المنورة",
  ...
  commercialListings: {
    ...
    hasElevator: "مصعد",
    adText1: "العنوان الاساسي",
    adText2: "النص الاعلاني",
    ...
    keyHolder: "مكان المفتاح",
    keyWithOffice: "مع المكتب",
    keyWithOwner: "مع المالك",
    keyWithGuard: "مع الحارس",
    guardPhone: "رقم الحارس",
    ...
    chooseCategoryFirst: "اختر تصنيف العقار أولاً",
  ...
  residentialSeekers: {
    ...
    sortNewest: "الأحدث",
    sortOldest: "الأقدم",
    sortRequestDateNewest: "تاريخ الطلب (الأحدث)",
    sortRequestDateOldest: "تاريخ الطلب (الأقدم)",
  ...
  advertisements: {
    ...
    listing: "عرض",
    statusRemoved: "تمت الازالة",
    statusOrdered: "تم الطلب",
    statusInstalled: "تم التركيب",
    statusAwaitingInstallation: "في انتظار التركيب",
    statusExpired: "انتهي الاعلان",
    propertyTypeRent: "ايجار",
    propertyTypeSale: "بيع",
    adTypeBoard: "لوحة",
    adTypeSticker: "استكر",
    adTypeBoardBar: "لوحة(بار)",
    installationTypeWall: "جداري",
    installationTypeGround: "ارضي",
    installationTypeFence: "تثبيت سور",
    installationTypeSticker: "استكر",
  },
  ...
  dashboard: {
    ...
    occupancyHelp:
      "العقود الإيجارية النشطة مقسومة على العقارات المعتمدة. سيظهر عقارك بمجرد الموافقة عليه.",
    ...
    revenueTrend: "اتجاه الإيرادات (آخر 12 شهرًا)",
  ...
  notifications: {
    ...
    newSeekerResidential: "طلب سكني جديد",
    newSeekerCommercial: "طلب تجاري جديد",
    newLead: "عميل جديد",
  ...
  clients: {
    pageTitle: "العملاء",
    pageSubtitle: "ابحث عن عميل لعرض جميع طلباته وإعلاناته",
    searchPlaceholder: "ابحث بالاسم أو رقم الجوال…",
    searchSerial: "ابحث بالرقم التسلسلي",
    sortLabel: "ترتيب",
    sortRecent: "الأحدث نشاطا",
    sortName: "الاسم",
    count: "{{count}} عميل",
    records: "{{count}} سجل",
    ...
    kindRequests: "الطلبات",
    kindSeekers: "الطلبات",
    kindListings: "العروض",
    kindLeads: "العملاء المحتملون",
    sectionTitle: "{{kind}} ({{count}})",
    phones: "أرقام الجوال",
    copyPhone: "نسخ الرقم",
    whatsapp: "واتساب",
