...
const en = {
  ...
  suggestions: {
    reasons: {
      ...
      different_listing_type: "Different listing type ({{listingType}})",
  ...
  commercialListings: {
    pageTitle: "Listings",
    pageSubtitle: "Manage property offers",
  ...
  advertisements: {
    ...
    location: "Location",
    quantity: "Quantity",
    locationChangeCount: "Location changes",
    adType: "Ad type",
...
const ar = {
  ...
  suggestions: {
    reasons: {
      ...
      different_listing_type: "نوع عرض مختلف ({{listingType}})",
  ...
  commercialListings: {
    pageTitle: "العروض",
    pageSubtitle: "إدارة العروض العقارية",
  ...
  advertisements: {
    ...
    location: "الموقع",
    quantity: "العدد",
    locationChangeCount: "عدد مرات تغيير الموقع",
    adType: "نوع الاعلان",
